...
new_array_train = np.empty(8)
new_array_train[0] = pca1.fit_transform(closest_hits_features_train[0:4])
new_array_train[1] = pca1.fit_transform(closest_hits_features_train[4:8])
new_array_train[2] = pca1.fit_transform(closest_hits_features_train[8:12])
new_array_train[3] = pca1.fit_transform(closest_hits_features_train[12:16])
new_array_train[4] = pca1.fit_transform(closest_hits_features_train[16:20])
new_array_train[5] = pca1.fit_transform(closest_hits_features_train[20:24])
new_array_train[6] = pca1.fit_transform(closest_hits_features_train[24:28])
new_array_train[7] = pca1.fit_transform(closest_hits_features_train[28:32])

new_array_test = np.empty(8)
new_array_test[0] = pca1.transform(closest_hits_features_test[0:4])
new_array_test[1] = pca1.transform(closest_hits_features_test[4:8])
new_array_test[2] = pca1.transform(closest_hits_features_test[8:12])
new_array_test[3] = pca1.transform(closest_hits_features_test[12:16])
new_array_test[4] = pca1.transform(closest_hits_features_test[16:20])
new_array_test[5] = pca1.transform(closest_hits_features_test[20:24])
new_array_test[6] = pca1.transform(closest_hits_features_test[24:28])
new_array_test[7] = pca1.transform(closest_hits_features_test[28:32])
...
random_array_train = np.empty(6)
random_array_train[0] = pca_new_1.fit_transform(train[['MatchedHit_X[0]', 'MatchedHit_X[1]', 'MatchedHit_X[2]', 'MatchedHit_X[3]']])
random_array_train[1] = pca_new_2.fit_transform(train[['MatchedHit_Y[0]', 'MatchedHit_Y[1]', 'MatchedHit_Y[2]', 'MatchedHit_Y[3]']])
random_array_train[2] = pca_new_3.fit_transform(train[['MatchedHit_Z[0]', 'MatchedHit_Z[1]']])
random_array_train[3] = pca_new_4.fit_transform(train[['MatchedHit_DY[0]', 'MatchedHit_DY[1]']])
random_array_train[4] = pca_new_5.fit_transform(train[['Lextra_X[0]', 'Lextra_X[1]', 'Lextra_X[2]', 'Lextra_X[3]']])
random_array_train[5] = pca_new_6.fit_transform(train[['Lextra_Y[0]', 'Lextra_Y[1]', 'Lextra_Y[2]', 'Lextra_Y[3]']])

random_array_test = np.empty(6)
random_array_test[0] = pca_new_1.transform(test[['MatchedHit_X[0]', 'MatchedHit_X[1]', 'MatchedHit_X[2]', 'MatchedHit_X[3]']])
random_array_test[1] = pca_new_2.transform(test[['MatchedHit_Y[0]', 'MatchedHit_Y[1]', 'MatchedHit_Y[2]', 'MatchedHit_Y[3]']])
random_array_test[2] = pca_new_3.transform(test[['MatchedHit_Z[0]', 'MatchedHit_Z[1]']])
random_array_test[3] = pca_new_4.transform(test[['MatchedHit_DY[0]', 'MatchedHit_DY[1]']])
random_array_test[4] = pca_new_5.transform(test[['Lextra_X[0]', 'Lextra_X[1]', 'Lextra_X[2]', 'Lextra_X[3]']])
random_array_test[5] = pca_new_6.transform(test[['Lextra_Y[0]', 'Lextra_Y[1]', 'Lextra_Y[2]', 'Lextra_Y[3]']])
